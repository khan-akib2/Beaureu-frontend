...
export default function LoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/auth/login`, { credentials: "include",  method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ email, password }) });
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-6 sm:p-10">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-8">
            ...
            <div className="mt-5">
              <Button variant="outline" className="w-full justify-center gap-3" onClick={handleGoogleLogin} isLoading={isGoogleLoading}>
